...
sub TSetupFileLocationEntry {
	...
	$ret = {
		...
		Flags => $self->ReadSet([ 'foVersionInfoValid', 'foVersionInfoNotValid', 'foTimeStampInUTC', 'foIsUninstExe', 'foCallInstructionOptimized', 'foTouch', 'foChunkEncrypted' ]),
	};
	return $ret;
}
1;
