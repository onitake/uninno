...
sub TSetupHeader {
	...
	$ret = {
		...
		ArchitecturesAllowed => $self->ReadSet([ 'paUnknown', 'paX86', 'paAMD64', 'paIA64' ]),
		ArchitecturesInstallIn64BitMode => $self->ReadSet([ 'paUnknown', 'paX86', 'paAMD64', 'paIA64' ]),
...
sub TSetupFileLocationEntry {
	...
	$ret = {
		...
		Flags => $self->ReadSet([ 'foVersionInfoValid', 'foVersionInfoNotValid', 'foTimeStampInUTC', 'foIsUninstExe', 'foCallInstructionOptimized', 'foTouch', 'foChunkEncrypted', 'foChunkCompressed' ]),
	};
	return $ret;
}
1;
