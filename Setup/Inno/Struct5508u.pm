package Setup::Inno::Struct5508u;
use strict;
...
sub TSetupFileLocationEntry {
	...
	$ret = {
		...
		Flags => $self->ReadSet([ 'foVersionInfoValid', 'foVersionInfoNotValid', 'foTimeStampInUTC', 'foIsUninstExe', 'foCallInstructionOptimized', 'foApplyTouchDateTime', 'foChunkEncrypted', 'foChunkCompressed', 'foSolidBreak' ]),
	};
	return $ret;
}
1;
